...
feature_dict = { "tfidf": [vectors_b, feature_size_b]}
...
for feature in feature_dict:
    ...
    plt.legend()
    plt.savefig("vectornoise_TF-IDF.png")
...
for feature in feature_dict:
    ...
    plt.legend()
    plt.savefig("Classnoise_TF-IDF.png")

file_path = 'Vectornoise(TF-IDF).json'
