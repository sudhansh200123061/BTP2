...
feature_dict = { "LDA": [vectors_b, feature_size_b]}
...
for feature in feature_dict:
    ...
    plt.legend()
    plt.savefig("vectornoise_LDA.png")
...
for feature in feature_dict:
    ...
    plt.legend()
    plt.savefig("Classnoise_LDA.png")

file_path = 'Vectornoise(LDA).json'
