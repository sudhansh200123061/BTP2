...
feature_dict = { "bow": [vectors_b, feature_size_b]}
...
for feature in feature_dict:
    ...
    plt.legend()
    plt.savefig("vectornoise_BOW.png")
...
for feature in feature_dict:
    ...
    plt.legend()
    plt.savefig("Classnoise_BOW.png")

file_path = 'Vectornoise(BOW).json'
